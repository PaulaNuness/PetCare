...
<body>
        ...
        <form action="" method="post" class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="apellido" name="apellido" maxlength="40"required>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="col-md-12 mb-5">
					<a href="login" id="btnSalir" type="button" class="btn btn-primary "> <!-- volta para login  --> 
						<%= ResourceBundle.getBundle("code").getString("registrar.salir") %>		
					</a>
					<a  href="javascript:crearUsuario()" id="btnConfirmar" type="button" class="btn btn-primary "> 
