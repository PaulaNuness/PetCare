            		...
            		<ul class="navbar-nav ">
                		<li class="nav-item dropdown">
                    		...
                    		<ul aria-labelledby="dropdownAreaGestion" class="dropdown-menu border-0 shadow">
                        		<li class="dropdown-item"><a href="clientes" target="_blank"><%= ResourceBundle.getBundle("code").getString("principal.clientes") %></a></li>
                        		<li class="dropdown-item"><a href="empleados" target="_blank"><%= ResourceBundle.getBundle("code").getString("principal.empleados") %></a></li>
                    		</ul>
               			 </li>
                		<li class="nav-item active">
                    		<a class="nav-link" href="consultas" target="_blank"><%= ResourceBundle.getBundle("code").getString("principal.consultas") %></a>
                		</li>
                		<li class="nav-item active">
                    		<a class="nav-link" href="#" target="_blank"><%= ResourceBundle.getBundle("code").getString("principal.inventario") %></a>
                		</li>
                		<li class="nav-item active">
                    		<a class="nav-link" href="chat" target="_blank"><%= ResourceBundle.getBundle("code").getString("principal.comunicacion") %></a>
                		</li>
            		</ul>
        		</div>
    		</div>
